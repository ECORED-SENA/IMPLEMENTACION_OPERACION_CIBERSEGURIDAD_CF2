...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4(data-aos="fade") Se debe tener muy presente los aspectos que se muestran en el siguiente recurso, sobre la importancia del control y la solidez del conjunto de controles; no olvidar la toma de nota sobre ellos:

    AcordeonB(tipo="b" clase-tarjeta="tarjeta border-bottom")
    ...
    p.mb-4(data-aos="fade") Se debe prestar atención a los siguientes aspectos a tener en cuenta en lo referente al riesgo residual:
    ...
    .row.justify-content-center.mb-4(data-aos="fade-down")
      .col-md-10.fondo-rosado.text-center.py-md-4.px-md-5.p-4
        p.mb-0 Una vez que se tengan los riesgos residuales se deben aplicar actividades de tratamiento para aquellos que como resultado, dieron críticos, altos o muy altos, según se considere.
