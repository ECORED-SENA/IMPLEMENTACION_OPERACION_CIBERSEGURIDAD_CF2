<template lang="pug">
.acordion
  .p-3.pb-0.p-md-4.pb-md-0(v-for="(elm, index) of elements" :key="elm.id" :class="[{'acordeon__selected1': selected === elm.id}, cardClass, 'mb-0']")
    ...
    .acordion__header.mb-3.mb-md-4(
      ...
      .d-flex.align-items-center
        .acordion__accion.acordion-a(v-if="tipo === 'a'")
      ...
      .acordion__accion.acordion-b(v-if="tipo === 'b'")
